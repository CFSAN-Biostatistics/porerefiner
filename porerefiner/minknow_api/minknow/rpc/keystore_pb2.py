...
_STOREREQUEST_VALUESENTRY.has_options = True
_STOREREQUEST_VALUESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_STOREREQUEST.fields_by_name['values'].has_options = True
_STOREREQUEST.fields_by_name['values']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\210\265\030\001'))
_REMOVEREQUEST.fields_by_name['names'].has_options = True
_REMOVEREQUEST.fields_by_name['names']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\210\265\030\001'))
_GETONEREQUEST.fields_by_name['name'].has_options = True
_GETONEREQUEST.fields_by_name['name']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\210\265\030\001'))
_GETRESPONSE_VALUESENTRY.has_options = True
_GETRESPONSE_VALUESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_WATCHREQUEST.fields_by_name['names'].has_options = True
_WATCHREQUEST.fields_by_name['names']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\210\265\030\001'))
_WATCHRESPONSE_VALUESENTRY.has_options = True
_WATCHRESPONSE_VALUESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
