...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in porerefiner/protocols/porerefiner/rpc/porerefiner_pb2_grpc.py depends on'
...
def add_PoreRefinerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('porerefiner.rpc.PoreRefiner', rpc_method_handlers)
